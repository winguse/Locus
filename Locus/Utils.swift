...
class Utils {
  ...
  private static let lockStateChange = "com.apple.springboard.lockstate"
  private static let lockStateComplete = "com.apple.springboard.lockcomplete"
  private static var locked = false

  static var lastHookCallTime: Date = .init()
  static var lastHookName: String = ""

  private static func lookCallback(name: String?) {
    if name == nil {
      return
    }
  ...
  static func hook() {
    ...
    for hookName in hookNames {
      ...
      CFNotificationCenterAddObserver(
        ...
        nil, // observer
        { (_: CFNotificationCenter?, _: UnsafeMutableRawPointer?, name: CFNotificationName?, _: UnsafeRawPointer?, _: CFDictionary?) in
